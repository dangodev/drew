...
const letters = [
  Matter.Bodies.fromVertices(13.59, 23.57, F, letterOptions),
  Matter.Bodies.fromVertices(40.485, 29.105, r, letterOptions),
  Matter.Bodies.fromVertices(68.71, 29.51, o, letterOptions),
  Matter.Bodies.fromVertices(104.37, 29.045, n, letterOptions),
  Matter.Bodies.fromVertices(132.995, 25.935, t, letterOptions),
  Matter.Bodies.fromVertices(176.07, 29.525, e, letterOptions),
  Matter.Bodies.fromVertices(210.985, 29.045, n, letterOptions),
  Matter.Bodies.fromVertices(246.705, 27.5, d, letterOptions),
  Matter.Bodies.fromVertices(303.05, 23.57, D, letterOptions),
  Matter.Bodies.fromVertices(341.341, 29.525, e, letterOptions),
  Matter.Bodies.fromVertices(373.89, 29.54, v, letterOptions),
  Matter.Bodies.fromVertices(406.88, 29.525, e, letterOptions),
  Matter.Bodies.rectangle(432.06, 23.35, 10.18, 44.68, letterOptions),
  Matter.Bodies.fromVertices(458.01, 29.51, o, letterOptions),
  Matter.Bodies.fromVertices(495.8, 34.47, p, letterOptions),
  Matter.Bodies.fromVertices(531.95, 29.525, e, letterOptions),
  Matter.Bodies.fromVertices(562.005, 29.105, r, letterOptions),

  Matter.Bodies.fromVertices(16.565, 121.18, U, letterOptions),
  Matter.Bodies.rectangle(45.375, 120.7, 10.37, 44.24, letterOptions),
  Matter.Bodies.fromVertices(90.63, 120.7, D, letterOptions),
  Matter.Bodies.fromVertices(128.93, 126.655, e, letterOptions),
  Matter.Bodies.fromVertices(161.58, 129.585, s, letterOptions),
  Matter.Bodies.rectangle(185.615, 101.71, 10.49, 9.16, letterOptions),
  Matter.Bodies.rectangle(185.62, 126.68, 10.24, 32.3, letterOptions),
  Matter.Bodies.fromVertices(211.875, 132.865, g, letterOptions),
  Matter.Bodies.fromVertices(249.1, 126.175, n, letterOptions),
  Matter.Bodies.fromVertices(284.015, 126.655, e, letterOptions),
  Matter.Bodies.fromVertices(314.075, 126.235, r, letterOptions),
