...
const letters = [
  Matter.Bodies.fromVertices(16.565, 24.05, U, letterOptions),
  Matter.Bodies.rectangle(45.375, 23.57, 10.37, 44.24, letterOptions),
  Matter.Bodies.fromVertices(90.63, 23.57, D, letterOptions),
  Matter.Bodies.fromVertices(128.93, 29.525, e, letterOptions),
  Matter.Bodies.fromVertices(161.58, 29.455, s, letterOptions),
  Matter.Bodies.rectangle(185.615, 4.58, 10.49, 9.16, letterOptions),
  Matter.Bodies.rectangle(185.62, 29.55, 10.24, 32.3, letterOptions),
  Matter.Bodies.fromVertices(211.875, 35.735, g, letterOptions),
  Matter.Bodies.fromVertices(249.1, 29.045, n, letterOptions),
  Matter.Bodies.fromVertices(284.015, 29.525, e, letterOptions),
  Matter.Bodies.fromVertices(314.075, 29.105, r, letterOptions),
  Matter.Bodies.fromVertices(13.59, 120.7, F, letterOptions),
  Matter.Bodies.fromVertices(40.485, 126.235, r, letterOptions),
  Matter.Bodies.fromVertices(68.71, 126.64, o, letterOptions),
  Matter.Bodies.fromVertices(104.37, 126.165, n, letterOptions),
  Matter.Bodies.fromVertices(132.995, 123.065, t, letterOptions),
  Matter.Bodies.fromVertices(176.07, 126.655, e, letterOptions),
  Matter.Bodies.fromVertices(210.985, 126.165, n, letterOptions),
  Matter.Bodies.fromVertices(246.705, 120.985, d, letterOptions),
  Matter.Bodies.fromVertices(303.05, 120.7, D, letterOptions),
  Matter.Bodies.fromVertices(341.341, 126.655, e, letterOptions),
  Matter.Bodies.fromVertices(373.89, 126.67, v, letterOptions),
  Matter.Bodies.fromVertices(406.88, 126.655, e, letterOptions),
  Matter.Bodies.rectangle(432.06, 120.48, 10.18, 44.68, letterOptions),
  Matter.Bodies.fromVertices(458.01, 126.64, o, letterOptions),
  Matter.Bodies.fromVertices(495.8, 131.6, p, letterOptions),
  Matter.Bodies.fromVertices(531.95, 126.655, e, letterOptions),
  Matter.Bodies.fromVertices(562.005, 126.235, r, letterOptions),
  Matter.Bodies.fromVertices(13.6, 216.35, F, letterOptions),
  Matter.Bodies.rectangle(36.6, 197.4, 10.49, 9.16, letterOptions),
  Matter.Bodies.rectangle(36.59, 222.35, 10.24, 32.3, letterOptions),
  Matter.Bodies.fromVertices(62.8, 228.65, g, letterOptions),
  Matter.Bodies.fromVertices(99.535, 222.855, u, letterOptions),
  Matter.Bodies.fromVertices(130.035, 221.9, r, letterOptions),
  Matter.Bodies.fromVertices(158, 222.35, e, letterOptions),
  Matter.Bodies.fromVertices(188, 221.9, r, letterOptions),
  Matter.Bodies.rectangle(208.215, 219.75, 17.89, 8.66, letterOptions),
  Matter.Bodies.fromVertices(236.5, 222.35, o, letterOptions),
  Matter.Bodies.fromVertices(271.55, 222.85, u, letterOptions),
  Matter.Bodies.fromVertices(300.75, 218.6, t, letterOptions),
  Matter.Bodies.fromVertices(329.95, 222.35, e, letterOptions),
  Matter.Bodies.fromVertices(359.95, 221.9, r, letterOptions),
];
